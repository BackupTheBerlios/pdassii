...
%\begin{figure*}[h!]
%	\begin{center}
%        		\framebox{\includegraphics[width=1.0\textwidth]{inicio.png}}
%     	\end{center}
...
%\begin{figure*}[h!]
%	\begin{center}
%        		\framebox{\includegraphics[width=1.0\textwidth]{error_inicio.png}}
%     	\end{center}
...
%\begin{figure*}[h!]
%	\begin{center}
%        		\framebox{\includegraphics[width=1.0\textwidth]{menu_principal.png}}
%     	\end{center}
...
%\begin{figure*}[h!]
%	\begin{center}
%        		\framebox{\includegraphics[width=1.0\textwidth]{menu_imprimir.png}}
%     	\end{center}
...
%\begin{figure*}[h!]
%	\begin{center}
%        		\framebox{\includegraphics[width=1.0\textwidth]{error_imprimir.png}}
%     	\end{center}
...
%\begin{figure*}[h!]
%	\begin{center}
%        		\framebox{\includegraphics[width=1.0\textwidth]{acierto_imprimir.png}}
%     	\end{center}
...
%\begin{figure*}[h!]
%	\begin{center}
%        		\framebox{\includegraphics[width=1.0\textwidth]{menu_consulta.png}}
%     	\end{center}
...
%\begin{figure*}[h!]
%	\begin{center}
%        		\framebox{\includegraphics[width=1.0\textwidth]{error_consulta.png}}
%     	\end{center}
