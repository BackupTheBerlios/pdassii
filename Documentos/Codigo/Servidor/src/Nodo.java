...
public class Nodo 
{
	...
	public Nodo( double a,double b,boolean bo, int ni, String desc,double lar,double anch)
	{
		this.x = a;
		this.y = b;
		this.tieneImpresora = bo;
		this.numImpresora = ni;
		this.descripcion = desc;
		this.largo = lar;
		this.ancho = anch;
	}
	
	public Nodo( double a,double b,boolean bo, int ni,double lar,double anc)
	{
		this.x = a;
		this.y = b;
		this.tieneImpresora = bo;
	...
	public void setnumImpresora(int ni){
		this.numImpresora = ni;
	}
